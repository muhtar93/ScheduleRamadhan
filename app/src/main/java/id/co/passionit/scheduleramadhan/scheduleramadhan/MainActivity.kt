...
class MainActivity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        listviewSchedule.onItemClickListener = AdapterView.OnItemClickListener { adapterView, view, position, id ->
    ...
    fun loadQueryAll() {
        ...
        listviewSchedule.adapter = notesAdapter
    }
    ...
    inner class NotesAdapter : BaseAdapter {
        ...
        override fun getView(position: Int, convertView: View?, parent: ViewGroup?): View? {
            ...
            if (convertView == null) {
                view = layoutInflater.inflate(R.layout.schedule_row, parent, false)
                vh = ViewHolder(view)
                view.tag = vh
                Log.i("SR", "set Tag for ViewHolder, position: " + position)
            } else {
                view = convertView
            ...
            vh.ivDelete.setOnClickListener {
                var dbManager = ScheduleManager(this.context!!)
    ...
    private class ViewHolder(view: View?) {
        ...
        init {
            this.tvTitle = view?.findViewById(R.id.textTitle) as TextView
            this.tvContent = view?.findViewById(R.id.textContent) as TextView
            this.ivEdit = view?.findViewById(R.id.imageEdit) as ImageView
            this.ivDelete = view?.findViewById(R.id.imageDelete) as ImageView
        }
    }
}
